...
Auto-Correlation Function (ACF) performs pearson correlation across different lags of the same time-series. In the code below we auto-correlate the first 20 lags and plot as a bar chart. ACF gives us an overview of the direct and in-direct correlation of the lags instead of their influence through time.
...
See the spike at Lag Order 12 and 17.
